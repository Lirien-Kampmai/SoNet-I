        ...
        public class WheelPhisics
        {
            ...
            private void ApplyDownForce()
            {
                if (m_LeftWheelCollider.isGrounded == true)
                    m_LeftWheelCollider.attachedRigidbody.AddForceAtPosition(m_LeftWheelHit.normal * -m_AddDownForceWheel * m_LeftWheelCollider.attachedRigidbody.velocity.magnitude, m_LeftWheelCollider.transform.position);

                if (m_RightWheelCollider.isGrounded == true)
                    m_RightWheelCollider.attachedRigidbody.AddForceAtPosition(m_RightWheelHit.normal * -m_AddDownForceWheel * m_RightWheelCollider.attachedRigidbody.velocity.magnitude, m_RightWheelCollider.transform.position);
            }
